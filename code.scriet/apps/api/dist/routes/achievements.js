...
const updateAchievementSchema = createAchievementSchema.partial().refine((value) => Object.keys(value).length > 0, { message: 'At least one field is required' });
...
achievementsRouter.get('/latest', async (req, res) => {
    try {
...
achievementsRouter.get('/featured', async (req, res) => {
    try {
...
achievementsRouter.get('/:idOrSlug', async (req, res) => {
    try {
...
// Create achievement
achievementsRouter.post('/', authMiddleware, requireRole('CORE_MEMBER'), async (req, res) => {
    try {
...
// Update achievement
achievementsRouter.put('/:id', authMiddleware, requireRole('CORE_MEMBER'), async (req, res) => {
    try {
        const authUser = getAuthUser(req);
...
// Delete achievement
achievementsRouter.delete('/:id', authMiddleware, requireRole('ADMIN'), async (req, res) => {
    try {
        const authUser = getAuthUser(req);
