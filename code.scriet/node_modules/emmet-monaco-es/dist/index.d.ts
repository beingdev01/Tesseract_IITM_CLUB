 ...
 */
export declare function emmetHTML(monaco?: typeof Monaco | undefined, languages?: string[], options?: EmmetOptions): () => void;
/**
 ...
 * @param options emmet options. `options.tokenizer` sets the tokenizer engine, default `'monarch'`. Use `'standard'` when a non-Monarch grammar (e.g. shiki) is active.
 */
export declare function emmetCSS(monaco?: typeof Monaco | undefined, languages?: string[], options?: EmmetOptions): () => void;
/**
 * emmet for `JSX` / `TSX`
 * @param monaco monaco self, if not provided, will use window.monaco
 ...
 * @param options emmet options. `options.tokenizer` sets the tokenizer engine, default `'monarch'`. Use `'standard'` when a non-Monarch grammar (e.g. shiki) is active.
 */
export declare function emmetJSX(monaco?: typeof Monaco | undefined, languages?: string[], options?: EmmetOptions): () => void;
