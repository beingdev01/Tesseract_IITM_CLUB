    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600 dark:text-zinc-400 mt-1">Upload images to Cloudinary</p>
        </div>
        ...
        <Card className="border-red-200 dark:border-red-900/40 bg-red-50 dark:bg-red-950/30">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-red-700 dark:text-red-300 mt-2">Only Admins and Coordinators can upload images.</p>
          </CardContent>
        </Card>
      </div>
    );
  ...
  return (
    <div className="space-y-6">
          ...
          <div
            className={`relative border-2 border-dashed rounded-xl p-8 text-center transition-all ${
              dragActive 
                ...
                : 'border-gray-300 dark:border-zinc-700 hover:border-amber-400 hover:bg-amber-50/50'
          ...
          >
            ...
            {uploading ? (
              <div className="py-8">
                ...
                <p className="text-gray-600 dark:text-zinc-400">Uploading...</p>
              </div>
            ) : (
              <>
                ...
                <p className="text-gray-900 dark:text-zinc-100 font-medium mb-1">
          ...
          <AnimatePresence>
            {error && (
              <motion.div
                ...
                exit={{ opacity: 0, y: -10 }}
                className="mt-4 p-4 bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-900/40 rounded-lg flex items-start gap-3"
              >
            ...
            <Card className="border-green-200 dark:border-green-900/40 bg-green-50 dark:bg-green-950/30">
              <CardHeader>
                ...
                <CardDescription className="text-green-700 dark:text-green-300">
                  Press <kbd className="px-1.5 py-0.5 bg-white dark:bg-surface-1 rounded border text-xs">Esc</kbd> or click Close to dismiss
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                {/* Preview */}
                <div className="rounded-lg overflow-hidden border border-green-200 dark:border-green-900/40 bg-white dark:bg-surface-1">
                  <img
                ...
                <div className="space-y-2">
                  <label htmlFor="image-upload-tool-url" className="text-sm font-medium text-gray-700 dark:text-zinc-300">
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      readOnly
                      className="font-mono text-sm bg-white dark:bg-surface-1"
      ...
      <Card>
        ...
        <CardContent className="space-y-3 text-sm text-gray-600 dark:text-zinc-400">
          <ol className="list-decimal list-inside space-y-2">
            ...
            <li>Press <kbd className="px-1.5 py-0.5 bg-gray-100 dark:bg-surface-2 rounded border text-xs">Esc</kbd> or click Close to dismiss the result</li>
          </ol>
