...
// ──────────────────────────────────────────────────────────────────
certificatesRouter.post('/generate', authMiddleware, requireRole('ADMIN'), requireFeature('certificates'), async (req: Request, res: Response) => {
  const authUser = getAuthUser(req)!;
...
// ──────────────────────────────────────────────────────────────────
certificatesRouter.post('/bulk', authMiddleware, requireRole('ADMIN'), requireFeature('certificates'), async (req: Request, res: Response) => {
  const authUser = getAuthUser(req)!;
...
// ──────────────────────────────────────────────────────────────────
certificatesRouter.post('/:certId/resend', authMiddleware, requireRole('ADMIN'), requireFeature('certificates'), async (req: Request, res: Response) => {
  const upperCertId = req.params.certId.toUpperCase();
